<?php namespace App\Crud\Unit\PartnershipAgentSeller\CustomAction;

use App\Crud\Unit\PartnershipAgentSeller\PartnershipAgentSellerCrudUnit;
...
class Terminate implements CustomActionTargetInterface
{
    ...
    {
        return PartnershipAgentSellerCrudUnit::NAME;
    }
